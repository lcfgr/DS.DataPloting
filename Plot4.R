...
plot(needed_power_consumption$DateTime,needed_power_consumption$Global_active_power,type="l",xlab="",ylab="Global Active Power")

plot(needed_power_consumption$DateTime,needed_power_consumption$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(needed_power_consumption$DateTime,needed_power_consumption$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
